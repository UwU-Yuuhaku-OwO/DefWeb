...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="sidebar pe-4 pb-3">
                    <nav class="navbar bg-secondary navbar-dark">
                        ...
                        <div class="navbar-nav w-100">
                            ...
                            <a href="{{url('admin/user')}}" class="nav-item nav-link inactive"><i class="fa fa-th me-2"></i>User
                                Manage</a>
                            </div>
                        </div>
                    </nav>
        ...
        <div class="content">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2"
                                src="../assets/ProductImg/291687523_189860590051806_4702903943460163817_n.jpg"
            ...
            <form class="row contact_form"   action="{{ url('ad-edit') }}" method="post" >
                @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="AdName" name="AdName" value="{{ $data->AdName }}"
                                            placeholder="Admin Name" >
                                        </TD>
                                    </tr>

                                    <tr class="text-white">
                                        <td scope="col">Login name:</td>
                                        <td>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="Pass" name="Pass" value="{{ $data->Pass }}" placeholder="Pass" >
                                        </TD>
                                    </tr>
    ...
    <script src="../assets/Admin/lib/chart/chart.min.js">
    ...
    <script src="../assets/Admin/lib/Admin/lib/tempusdominus/js/moment.min.js"></script>
    <script src="../assets/Admin/lib/Admin/lib/tempusdominus/js/moment-timezone.min.js"></script>
    <script src="../assets/Admin/lib/Admin/lib/tempusdominus/js/tempusdominus-bootstrap-4.min.js"></script>
</body>
