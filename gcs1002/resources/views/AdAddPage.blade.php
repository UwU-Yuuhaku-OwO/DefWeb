...
<body>
    <div class="container-fluid position-relative d-flex p-0">
                ...
                <div class="d-flex align-items-center ms-4 mb-4">
                    <div class="position-relative">
                        <img class="rounded-circle"
                            src="../public/assets/ProductImg/291687523_189860590051806_4702903943460163817_n.jpg"
        ...
        <div class="content">
            ...
            <form class="row contact_form" action="{{ url('ad-save') }}" method="post" novalidate="novalidate">
                @csrf
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="AdName" name="AdName" value=""
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="Pass" name="Pass" value="" placeholder="Pass" >
                                        </TD>
                                    </tr>
