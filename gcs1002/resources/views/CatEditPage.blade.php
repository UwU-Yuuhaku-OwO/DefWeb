                        ...
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                {{-- <h3>Welcome New Member ! <br>
                                        Sign up now</h3> --}}
                                <form class="row contact_form" action="{{ url('cat-edit') }}" method="post" novalidate="novalidate">
                                    @csrf
                                    <div class="col-md-12 form-group p_star">
                                        <input type="hiden" class="form-control" id="id" name="id" value="{{ $data->id }}>

                                    </div>

                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="cat_name" name="cat_name" value=""
                                            placeholder="Category Name" value="{{ $data->cat_name }}">
                                    </div>
