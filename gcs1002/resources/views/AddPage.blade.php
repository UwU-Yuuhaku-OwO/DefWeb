    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <form class="row contact_form" action="{{ url('product-save') }}" method="post" novalidate="novalidate">
                @csrf
                <input type="hidden" id="img_pass" name="img_pass" value="">
                        ...
                        <div class="table-responsive">
                            <table class="table text-start align-middle table-bordered table-hover mb-0">
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <input type="text" class="form-control" id="product" name="product" value=""  placeholder="Products Name">
                                        </TD>
                                    </tr>
                                    ...
                                    <tr class="text-white">
                                        ...
                                        <td>
                                            <img src="null" id="blah" alt="your image" width="400" height="400" />
                                        </TD>
                                    </tr>
